...
//    public static final String HOST = "10.0.2.2:8080/DnDEncounters";
//    public static final String BASE_URL = "http://10.0.2.2:8080/DnDEncounters";
    public static final String HOST = "dndencounters.azurewebsites.net/DnDEncounters";
//    public static final String BASE_URL = "http://dndencounters.azurewebsites.net/DnDEncounters";

    public static final String BASE_URL = "http://10.0.2.2:8080/AuthService/test";

    public static final String LOGIN = "/auth/login";
    public static final String LOGOUT = "/auth/logout";

    public static final String ACCOUNT = "/account";
    public static final String ACCOUNT_DETAILS = "/account/%d";
    ...
    public static final List<String> profileParams = Arrays.asList(TransactionParams.FROM, TransactionParams.TO,
            TransactionParams.AMOUNT, TransactionParams.CURRENCY);
